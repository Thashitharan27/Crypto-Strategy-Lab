...
class MainWindow(QMainWindow):
    ...
    def _build_config(self):
        ...
        for obsolete in (partial_sl,partial_tp,protective_stop,trailing,both_open,vwap_group,random_group,be_rule,remaining_timeout,be): obsolete.parentWidget().setVisible(False)
