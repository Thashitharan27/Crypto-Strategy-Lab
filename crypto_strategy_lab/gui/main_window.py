...
class MainWindow(QMainWindow):
    ...
    def apply_values(self,d):
        ...
        for name in ("enable_directional_di_spread_range","enable_directional_adx_range","enable_directional_atr_pct_range","enable_directional_rsi_range","enable_directional_close_location_range","enable_directional_momentum_range"): getattr(self,name).setChecked(bool(values.get(name,False)))
