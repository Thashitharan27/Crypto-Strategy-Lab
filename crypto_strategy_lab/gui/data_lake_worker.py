...
class DataLakeGuiBacktestWorker(BacktestWorker):
    ...
    def _prepare_bundle(self) -> BacktestDataBundle:
        ...
        return load_backtest_bundle(
            ...
            sr_zone_padding_atr=getattr(self.config, "sr_zone_padding_atr", 0.10),
            sr_zone_max_cluster_span_atr=getattr(self.config, "sr_zone_max_cluster_span_atr", 0.50),
            sr_min_rejection_atr=getattr(self.config, "sr_min_rejection_atr", 0.50),
