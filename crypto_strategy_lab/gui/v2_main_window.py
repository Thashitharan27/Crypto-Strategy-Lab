...
FEATURE_GROUPS = (
    ...
    ("Support / Resistance", (
        ...
        "sr_zone_width_atr", "sr_zone_padding_atr", "sr_zone_max_cluster_span_atr",
        "sr_min_rejection_atr", "sr_near_distance_atr",
    ...
    def __init__(self, value, *, excluded=(), groups=None, parent=None):
        ...
        self._dependents = {
            ...
            "enable_support_resistance_analysis": (
                ...
                "sr_1d_pivot_left", "sr_1d_pivot_right", "sr_1d_lookback_bars",
                "sr_zone_width_atr", "sr_zone_padding_atr", "sr_zone_max_cluster_span_atr",
                "sr_min_rejection_atr", "sr_near_distance_atr", "enable_sr_hold_confirmation",
