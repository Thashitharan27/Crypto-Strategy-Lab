...
EVIDENCE_GROUPS = (
    ...
    (
        ...
        (
            ...
            "ICH_KIJUN_FLAT_BARS", "ICH_CURRENT_CLOUD_STATE",
            "ICH_FUTURE_CLOUD_STATE", "ICH_CLOUD_THICKNESS_ATR",
            "ICH_FUTURE_CLOUD_THICKNESS_ATR", "ICH_KUMO_TWIST",
            "ICH_CHIKOU_VS_PRICE", "ICH_CLOUD_DISTANCE_ATR",
        ),
    ),
    (
        "Momentum & Price",
