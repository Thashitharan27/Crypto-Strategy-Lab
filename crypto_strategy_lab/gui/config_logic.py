...
DEFAULT_GUI_CONFIG: dict[str, Any] = {
    ...
    "enable_bull_regime_short_filter": False, "bull_regime_lookback_days": 90, "bull_regime_return_threshold": 0.20, "enable_bear_regime_adx_filter": False, "bear_regime_adx_minimum": 25.0,
