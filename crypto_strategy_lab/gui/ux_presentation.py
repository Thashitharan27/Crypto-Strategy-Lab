...
FIELDS = {
    ...
    "sr_zone_width_atr": FieldPresentation(
        "Zone Merge Gap",
        "Merge two validated rejection zones only when the gap between their edges is within this ATR distance.",
        unit=" × ATR",
        decimals=2,
    ),
    "sr_zone_padding_atr": FieldPresentation(
        "Minimum Zone Width",
        "Minimum width of a pivot candle's wick-to-body rejection area. ATR only supplies a floor; it does not center the zone.",
        unit=" × ATR",
        decimals=2,
    ),
    "sr_zone_max_cluster_span_atr": FieldPresentation(
        "Maximum Zone Width",
        "Maximum width of one rejection zone or merged structural cluster, measured using confirmation-time ATR.",
        unit=" × ATR",
        decimals=2,
    ),
    "sr_min_rejection_atr": FieldPresentation(
        "Minimum Pivot Rejection",
        "Minimum close displacement away from the wick/body zone by pivot confirmation. Filters local swings that never produced meaningful rejection.",
        unit=" × ATR",
        decimals=2,
    ),
...
ENUM_LABELS = {
    "ema_920_trade_plan": {
        ...
        "EMA_20_100_CROSS": "20/100 Cross — Long Only",
        "EMA_20_100_CROSS_SHORT": "20/100 Cross — Short Only",
        "EMA_20_100_CROSS_BOTH": "20/100 Cross — Long + Short",
    },
    "entry_timing_mode": {
