...
class DataLakeProductionBacktestEngine(DataLakeBacktestEngine, SRDynamicTPBacktestEngine):
    ...
    def _validate_support_resistance_features(
        ...
        expected = {
            ...
            "zone_padding_atr": float(getattr(config, "sr_zone_padding_atr", 0.10)),
            "max_cluster_span_atr": float(getattr(config, "sr_zone_max_cluster_span_atr", 0.50)),
            "min_rejection_atr": float(getattr(config, "sr_min_rejection_atr", 0.50)),
