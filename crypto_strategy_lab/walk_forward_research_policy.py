...
def research_policy_schema() -> dict[str, Any]:
    ...
    return {
        ...
        "principles": [
            ...
            "Episode identity only scopes teacher comparisons. Structural novelty must be decided from current entry-time evidence, settled teacher outcome, active causal rules, and previously reviewed teachers; future episode length or later observations are forbidden.",
