...
class Position:
    ...
    atr_checkpoint_extension_enabled: bool = False; atr_checkpoint_next_r: float = 1.0; atr_checkpoint_count: int = 0; atr_checkpoint_pass_count: int = 0; atr_checkpoint_fail_count: int = 0; atr_checkpoint_last_time: Optional[object] = None; atr_checkpoint_last_r: Optional[float] = None; atr_checkpoint_last_di_spread: Optional[float] = None; atr_checkpoint_last_bb_width: Optional[float] = None; atr_checkpoint_last_passed: bool = False; atr_checkpoint_initial_tp: Optional[float] = None; atr_checkpoint_final_tp_r: Optional[float] = None; atr_checkpoint_profit_lock_r: Optional[float] = None
    r_step_trailing_enabled: bool = False; r_step_trailing_active: bool = False; r_step_next_checkpoint_r: float = 2.0; r_step_checkpoint_count: int = 0; r_step_last_checkpoint_r: Optional[float] = None; r_step_last_checkpoint_time: Optional[object] = None; r_step_locked_r: Optional[float] = None; r_step_initial_tp: Optional[float] = None
