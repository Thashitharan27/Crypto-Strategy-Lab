...
class ExitReason(str, Enum): TP="TP"; SL="SL"; EMA_20_100_CROSS="EMA_20_100_CROSS"; ATR_CHECKPOINT_PROFIT_LOCK="ATR_CHECKPOINT_PROFIT_LOCK"; R_STEP_TRAILING_STOP="R_STEP_TRAILING_STOP"; TRAILING_STOP="TRAILING_STOP"; BE="BE"; BE_COST_ADJUSTED="BE_COST_ADJUSTED"; BE_R_OFFSET="BE_R_OFFSET"; PROFILE_TIMEOUT="PROFILE_TIMEOUT"; END_OF_DATA="END_OF_DATA"
class ExitSource(str, Enum): INTRABAR="1M_INTRABAR"; FALLBACK_15M="15M_FALLBACK"; STRATEGY_OPEN="STRATEGY_OPEN"; END_OF_DATA="END_OF_DATA"
...
class Position:
    ...
    uncapped_quantity: float = 0.0; effective_leverage: float = 0.0; distance_unit: float = 0.0
    position_sizing_stop_override_enabled: bool = False; position_sizing_stop_override_applied: bool = False
    position_sizing_stop_multiple: float = 0.0; position_sizing_reference_distance: float = 0.0
