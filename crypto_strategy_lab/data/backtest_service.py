    ...
    if feature_config is not None:
        ...
        if enable_support_resistance_analysis:
            feature_parameters["support_resistance"] = {
                ...
                "sr_zone_padding_atr": float(sr_zone_padding_atr),
                "sr_zone_max_cluster_span_atr": float(sr_zone_max_cluster_span_atr),
                "sr_min_rejection_atr": float(sr_min_rejection_atr),
