"""Temporary Stage 19 helper for large test files that need exact migrations."""
...
# Normalize the whole analysis-only regression class in one operation.  The end
# marker targets the original detector class docstring, so repeated runs cannot
# duplicate helper methods or empty class declarations.
replace_between(
    "tests/test_support_resistance.py",
