...
TRADE_R_COLUMN_METADATA = {
    ...
    "di_spread_change": "DI spread change versus five strategy candles ago.",
    ...
    "bb_width_change": "Raw BB width change versus five strategy candles ago.",
    "bb_width_change_pct": "BB width percentage change versus five strategy candles ago.",
