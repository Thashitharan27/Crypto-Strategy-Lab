...
REMOVED_FIELDS = {'short_vwap_minimum_distance_atr', 'long_momentum_minimum_return', 'directional_long_adx_maximum', 'enable_directional_adx_filter', 'directional_short_adx_minimum', 'enable_long_momentum_filter', 'enable_bull_regime_short_filter', 'bear_regime_adx_minimum', 'enable_short_vwap_distance_filter', 'enable_bear_regime_adx_filter', 'long_momentum_lookback_hours', 'biased_short_adx_maximum', 'enable_biased_short_adx_cap'}
